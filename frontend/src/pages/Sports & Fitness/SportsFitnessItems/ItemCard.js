  ...
  return (
    <>
      ...
      <div style={{ margin: "auto", display: "flex", justifyContent: "center" }}>
        <img src="https://images-eu.ssl-images-amazon.com/images/G/31/Sports/Jupiter21/Phase4/CLP/Header/1500x300-UNREC.jpg" alt="" style={{ width: "100%", marginTop: "7vh" }} />
      </div>
      ...
      <div style={{ margin: "auto", display: "flex", justifyContent: "center" }}>
        <img src="https://images-eu.ssl-images-amazon.com/images/G/31/img19/Sports/1203782_1034110_EF_1500x300._CB1198675309_.jpg" alt="" style={{ width: "100%", marginTop: "7vh" }} />
      </div>
      <div style={{ margin: "auto", display: "flex", justifyContent: "center" }}>
